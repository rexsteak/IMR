...
namespace Inspinia_MVC5
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //Google Maps Styling
            bundles.Add(new StyleBundle("~/GoogleMaps/css").Include("~/Content/plugins/googleMaps/googleMapsCSS.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/clockpickerStyles").Include(
                      "~/Content/plugins/clockpicker/bootstrap-clockpicker.css",
                      "~/Content/plugins/clockpicker/bootstrap-clockpicker.min.css",
                      "~/Content/plugins/clockpicker/jquery-clockpicker.css",
                      "~/Content/plugins/clockpicker/jquery-clockpicker.min.css"));

            // clockpicker scripts
            bundles.Add(new ScriptBundle("~/plugins/clockpicker").Include(
                      "~/Scripts/plugins/clockpicker/bootstrap-clockpicker.js",
                      "~/Scripts/plugins/clockpicker/bootstrap-clockpicker.min.js",
                      "~/Scripts/plugins/clockpicker/jquery-clockpicker.js",
                      "~/Scripts/plugins/clockpicker/jquery-clockpicker.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/googleMaps").Include("~/Scripts/plugins/googleMaps/googleMapsScript.js"));
